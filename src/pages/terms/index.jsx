  ...
  return (
    <HelmetProvider>
      <Container className="legal-header">
        <Helmet>
          <meta charSet="utf-8" />
          <title>Terms &amp; Conditions | {meta.title}</title>
          <meta name="description" content="Terms and Conditions for Carlos Padilla's website application." />
        </Helmet>
        ...
        <Row className="sec_sp">
          <Col lg="10">
            ...
            <p>
              These terms and conditions apply to the <strong>Carlos Padilla</strong> website
            ...
            <h3 className="legal-section-title">Changes to the Application</h3>
            <p>
              ...
              the Application or charge for their services at any time and for any reason. The
              Service Provider assures you that any charges for the Application or its services
              will be clearly communicated to you.
            </p>

            <h3 className="legal-section-title">Personal Data &amp; Security</h3>
            <p>
            ...
            <h3 className="legal-section-title">Third-Party Services</h3>
            <p>
            ...
            <p>
              ...
              Service Provider cannot be held responsible if the Application does not function
              at full capacity due to lack of access to Wi-Fi or if you have exhausted your
              data allowance.
            </p>
            <p>
              If you are using the application outside of a Wi-Fi area, please be aware that
              your mobile network provider's agreement terms still apply. Consequently, you may
              incur charges from your mobile provider for data usage during the connection to
              the application, or other third-party charges. By using the application, you
              accept responsibility for any such charges, including roaming data charges if you
              use the application outside of your home territory (i.e., region or country)
              without disabling data roaming. If you are not the bill payer for the device on
              which you are using the application, they assume that you have obtained permission
              from the bill payer.
            </p>
            <p>
            ...
            <h3 className="legal-section-title">Updates &amp; Termination</h3>
            <p>
              ...
              system (and for any additional systems they decide to extend the availability of
              the application to) may change, and you will need to download the updates if you
            ...
            <p>
              ...
              terminate its use at any time without providing termination notice to you. Unless
              they inform you otherwise, upon any termination, (a) the rights and licenses
              granted to you in these terms will end; (b) you must cease using the application,
              and (if necessary) delete it from your device.
            </p>

            <h3 className="legal-section-title">Changes to These Terms and Conditions</h3>
            <p>
